...
class AniListApi @Inject constructor(private val client: OkHttpClient, private val json: Json) {
    ...
    private fun parseMedia(o: JsonObject) = Anime(
        ...
        genres = o["genres"]?.jsonArray?.map { it.jsonPrimitive.content },
